    ...
    <nav class="flex items-center justify-between p-6 lg:px-8" aria-label="Global">
      <div class="flex lg:flex-1">
        <a href="#" class="-m-1.5 p-1.5">
          ...
          <img class="w-2/5 h-auto" src="{{url('/images/findmyspot.svg')}}">
        </a>
      </div>
      ...
      <div class="hidden lg:flex lg:gap-x-12">
        <a href="#" class="text-sm font-semibold leading-6 text-blue-800">Le produit</a>

        <a href="#fonctionnalites" class="text-sm font-semibold leading-6 text-blue-800">Les fonctionnalités</a>

        <a href="#about" class="text-sm font-semibold leading-6 text-blue-800">Qui sommes nous ?</a>
      ...
      <a href="/login" class="text-sm font-semibold leading-6 text-blue-800">Se connecter</a>
        <a href="/register" class="text-sm font-semibold leading-6 text-gray-900">S'inscrire </a>
      </div>
    </nav>
      ...
      <div class="fixed inset-y-0 right-0 z-50 w-full overflow-y-auto bg-white px-6 py-6 sm:max-w-sm sm:ring-1 sm:ring-gray-900/10">
        ...
        <div class="mt-6 flow-root">
          <div class="-my-6 divide-y divide-gray-500/10">
            ...
            <div class="py-6">
              <a href="#" class="-mx-3 block rounded-lg px-3 py-2.5 text-base font-semibold leading-7 text-blue-800 hover:bg-gray-50">Se connecter</a>
            </div>
          </div>
        </div>
      </div>
  ...
  <div class="relative isolate px-6 pt-14 lg:px-8">
    ...
    <div class="mx-auto max-w-2xl py-32 sm:py-48 lg:py-56">
      ...
      <div class="text-center">
        <h1 class="text-4xl font-bold tracking-tight text-blue-800 sm:text-6xl">Partagez vos meilleurs spots avec votre entourage</h1>
...
<div class="bg-white py-24 sm:py-32" id="fonctionnalites">
  <div class="mx-auto max-w-7xl px-6 lg:px-8">
    <div class="mx-auto max-w-2xl lg:text-center">
      <p class="mt-2 text-3xl font-bold tracking-tight text-blue-800 sm:text-4xl">Les fonctionnalités</p>
      <p class="mt-6 text-lg leading-8 text-gray-600">Quis tellus eget adipiscing convallis sit sit eget aliquet quis. Suspendisse eget egestas a elementum pulvinar et feugiat blandit at. In mi viverra elit nunc.</p>
    </div>
    <div class="mx-auto mt-16 max-w-2xl sm:mt-20 lg:mt-24 lg:max-w-4xl">
      <dl class="grid max-w-xl grid-cols-1 gap-x-8 gap-y-10 lg:max-w-none lg:grid-cols-2 lg:gap-y-16">
        <div class="relative pl-16">
          <dt class="text-base font-semibold leading-7 text-blue-800">
            <div class="absolute left-0 top-0 flex h-10 w-10 items-center justify-center rounded-lg bg-blue-800">
...
<div class="mx-auto -mt-12 max-w-7xl px-6 sm:mt-0 lg:px-8 xl:-mt-8" id="about">
      <div class="mx-auto max-w-2xl lg:mx-0 lg:max-w-none">
        <h2 class="text-3xl font-bold tracking-tight text-blue-800 sm:text-4xl">Qui sommes nous ?</h2>
          ...
          <div class="lg:flex lg:flex-auto lg:justify-center">
            <dl class="w-64 space-y-8 xl:w-80">
              <div class="flex flex-col-reverse gap-y-4">
                ...
                <dd class="text-5xl font-semibold tracking-tight text-blue-800">44 million</dd>
              </div>
              <div class="flex flex-col-reverse gap-y-4">
                <dt class="text-base leading-7 text-gray-600">Assets under holding</dt>
                <dd class="text-5xl font-semibold tracking-tight text-blue-800">$119 trillion</dd>
              </div>
              <div class="flex flex-col-reverse gap-y-4">
                <dt class="text-base leading-7 text-gray-600">New users annually</dt>
                <dd class="text-5xl font-semibold tracking-tight text-blue-800">46,000</dd>
              </div>
            </dl>
          </div>
        </div>
...
<footer class="bg-white" aria-labelledby="footer-heading">
  ...
  <div class="mx-auto max-w-7xl px-6 pb-8 pt-16 sm:pt-24 lg:px-8 lg:pt-32">
    <div class="xl:grid xl:grid-cols-3 xl:gap-8">
      <div class="space-y-8">
      <img class="w-40 h-auto" src="{{url('/images/findmyspot.svg')}}">
      ...
      <div class="mt-16 grid grid-cols-2 gap-8 xl:col-span-2 xl:mt-0">
        <div class="md:grid md:grid-cols-2 md:gap-8">
          <div>
            <h3 class="text-sm font-semibold leading-6 text-blue-800">Solutions</h3>
          ...
          <div class="mt-10 md:mt-0">
            <h3 class="text-sm font-semibold leading-6 text-blue-800">Support</h3>
            <ul role="list" class="mt-6 space-y-4">
              <li>
        ...
        <div class="md:grid md:grid-cols-2 md:gap-8">
          <div>
            <h3 class="text-sm font-semibold leading-6 text-blue-800">Company</h3>
            <ul role="list" class="mt-6 space-y-4">
              <li>
          ...
          <div class="mt-10 md:mt-0">
            <h3 class="text-sm font-semibold leading-6 text-blue-800">Legal</h3>
            <ul role="list" class="mt-6 space-y-4">
              <li>
