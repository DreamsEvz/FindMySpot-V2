...
const ExpendableMenu = ({ changeAddPointState, changeDescriptionPoint, changeNamePoint }) => {
    ...
    return (
        <>
            <div className='flex flex-col m-auto p-10 shadow w-full'>
            <button className='bg-white hover:bg-blue-900 hover:text-white text-blue-900 bg-blue-800 font-semibold py-2 px-4 border border-gray-400 rounded shadow' onClick={() => { toggleMenu(); }}>Ajouter un point</button>
                {isOpen && 
